...
import Hack_o_relay from './assets/CoviHack Page assets/Hack-o-relay-removebg-preview.png';
    ...
    return(
        <div className="coviheader">
            ...
            <div className="coviheader-text">
                ...
                <h1 data-aos="fade-up">Hack-o-Relay</h1>
                <h3>Starting soon..</h3>
            ...
            <img src={Hack_o_relay} alt="covihack"  className="covi-logo"/>
        </div>
    );
}
